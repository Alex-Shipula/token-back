...
const cryptoDogsUrl = "https://token.dog:8010";
...
//convert Data-Unix format
function covertToUnixTime(yourDate) {
  if ((yourDate == null) || (yourDate === "")) { return yourDate }
  else {
    let timestap = yourDate.split('/').map(a => Number(a));
    let birthday = new Date([timestap[2], timestap[0], timestap[1]]);
    let copy = new Date();
    return (copy.setTime(birthday.getTime())) / 1000;
  }
}
    ...
    dogs.map((dog, j) => {
      ...
      dog._options.attributes.map((attribute, i) => {
        ...
        if (attribute == "Name") {
          ...
          _obj["value"] = covertToUnixTime(dog[attribute]);
          if (_obj != {}) {
            _attributes[_attributes.length] = _obj;
          }
        }
...
exports.getById = (req, res) => {
  ...
  DogsModel.findOne({
    ...
    dog._options.attributes.map((attribute, i) => {
      ...
      if (attribute == "Name") {
      ...
      else if (attribute == "DogID") {
        let _obj = {};
        _obj["trait_type"] = "00-DogID";
        _obj["value"] = dog[attribute];
        if (_obj != {}) {
          _attributes[_attributes.length] = _obj;
        }
      }
      else if (attribute == "Races") {
        let _obj = {};
        _obj["trait_type"] = "20-Races";
        _obj["value"] = dog[attribute];
        if (_obj != {}) {
          _attributes[_attributes.length] = _obj;
        }
        ...
        let _obj = {};
        _obj["trait_type"] = "23-Gold Medal";
        _obj["value"] = dog[attribute];
        if (_obj != {}) {
          _attributes[_attributes.length] = _obj;
        }
      }
      else if (attribute == "Silver") {
        let _obj = {};
        _obj["trait_type"] = "24-Silver Medal";
        _obj["value"] = dog[attribute];
        if (_obj != {}) {
          _attributes[_attributes.length] = _obj;
        }
      }
      else if (attribute == "Bronze") {
        let _obj = {};
        _obj["trait_type"] = "25-Bronze Medal";
        _obj["value"] = dog[attribute];
        if (_obj != {}) {
          _attributes[_attributes.length] = _obj;
        }
      ...
      else if (attribute == "Owner_ID") {
        let _obj = {};
        _obj["trait_type"] = "03-Owner_ID";
        _obj["value"] = dog[attribute];
        if (_obj != {}) {
          _attributes[_attributes.length] = _obj;
        }
      }
      else if (attribute == "Mom_ID") {
        let _obj = {};
        _obj["trait_type"] = "01-Mom_ID";
        _obj["value"] = dog[attribute];
        if (_obj != {}) {
          _attributes[_attributes.length] = _obj;
        }
      }
      else if (attribute == "Dad_ID") {
        let _obj = {};
        _obj["trait_type"] = "02-Dad_ID";
        _obj["value"] = dog[attribute];
        if (_obj != {}) {
          _attributes[_attributes.length] = _obj;
        }
        ...
        let _obj = {};
        _obj["display_type"] = "boost_number";
        _obj["trait_type"] = "Generation";
        _obj["value"] = dog[attribute];
        if (_obj != {}) {
          _attributes[_attributes.length] = _obj;
        ...
        let _obj = {};
        _obj["trait_type"] = "11-EXP";
        _obj["value"] = dog[attribute];
        if (_obj != {}) {
          _attributes[_attributes.length] = _obj;
        }
      }
      else if (attribute == "Race_EXP") {
        let _obj = {};
        _obj["trait_type"] = "21-Race_EXP";
        _obj["value"] = dog[attribute];
        if (_obj != {}) {
          _attributes[_attributes.length] = _obj;
        }
      ...
      else if (attribute == "PurityPer") {
        let _obj = {};
        _obj["display_type"] = "boost_percentage";
        _obj["trait_type"] = "PurityPer";
        _obj["value"] = dog[attribute];
        if (_obj != {}) {
          _attributes[_attributes.length] = _obj;
        }
    ...
    _external_url = "https://token.dog/dog-page/" + dog.DogID;
    let _dog = {
      "name": _name,
      "description": _description,
      "image": _img,
